...
pygame.font.init()
FONT = os.path.join("res", "Courgette-Regular.ttf")
...
class MAIN:
    # Header
    HEADING = head.render("MyChess", True, colors.WHITE)

    # Window Icon
    ICON = ICON

    # Background
    BG = BGSPRITE.subsurface((500, 0, 500, 500))
...
class SINGLE:
    ...
    # Start button
    START = small.render("Start Game", True, colors.GREEN)
